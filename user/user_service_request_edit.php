...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
    ...
    if ( !isset($_GET["id"]) ) {
        header("location: user_service_request_index.php");
        exit;
    }
    ...
    do {
        ...
        $sql = "UPDATE service_requests S,request_meta R 
                SET category_id = '$category_id', owner_name = '$owner', contact = '$phone', email = '$email', address = '$address', vehicle_name = '$vname', vehicle_regno = '$regno', vehicle_model = '$vmodel', service_type = '$service_type', services = '$service_id'
...
<?php 
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="user_service_request_index.php" role="button">Cancel</a>
                </div>
            </div>
